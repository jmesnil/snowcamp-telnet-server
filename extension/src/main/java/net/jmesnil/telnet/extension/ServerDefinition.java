...
public class ServerDefinition extends PersistentResourceDefinition {
    ...
    private static final String LISTENER_CAPABILITY_NAME = "net.jmesnil.telnet.server";
    ...
    private ServerDefinition() {
        super(TelnetExtension.SERVER_PATH,
                TelnetExtension.getResolver("server"),
                new ServerAdd(),
                new ServerRemove());
    }
    ...
    private static class ServerAdd extends AbstractAddStepHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
            ...
            TelnetService service = new TelnetService(upperCase, reverse);
            context.getServiceTarget().addService(TelnetService.SERVER.append(name), service)
